...
import {
    ...
    SiNeovim, SiNextdotjs, SiReact, SiRust, SiTypescript, SiWebstorm, SiZig,SiNodedotjs,SiSpringboot,
    SiNestjs,SiReactquery,SiJest,SiVitest,SiSpring, SiVisualstudio, SiVisualstudiocode, SiDocker
} from "react-icons/si";
